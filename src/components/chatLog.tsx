...
export const ChatLog = ({ messages }: Props) => {
  ...
  return (
    <div className="absolute right-0 top-0 w-full md:w-96 h-[100svh] pb-64 pointer-events-none">
      <div className="max-h-full px-4 pt-24 pb-64 overflow-y-auto scroll-hidden pointer-events-auto">
        {messages.map((msg, i) => {
          return (
